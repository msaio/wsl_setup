...
select yn in "Yes" "No"; do
  case $yn in
    Yes )
      ...
      curl -fLo ~/.config/nvim/init.vim https://raw.githubusercontent.com/msaio/hf/master/U18.04/init.vim
      # 4th, install plugin
    ...
    Yes )
      ...
      case $shell in
        bash_it )
          ...
          # 3rd, get public config file from github.com/msaio
          curl -fLo ~/.bashrc https://raw.githubusercontent.com/msaio/hf/master/U18.04/.bashrc
